...
internal sealed class ExternalHyperlinks : IExternalHyperlinks
{
    ...
    public IExternalHyperlink HowProtoDriveWorks => GetHyperlink(_urlConfig.HowProtoDriveWorks);

    public IExternalHyperlink UseOnDemandSync => GetHyperlink(_urlConfig.UseOnDemandSync);

    public IExternalHyperlink SyncFoldersToProtonDrive => GetHyperlink(_urlConfig.SyncFoldersToProtonDrive);

    public IExternalHyperlink HowSharedWithMeFilesWork => GetHyperlink(_urlConfig.HowSharedWithMeFilesWork);

    public IExternalHyperlink FrequentlyAskedQuestions => GetHyperlink(_urlConfig.FrequentlyAskedQuestions);
