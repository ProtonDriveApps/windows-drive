...
using Proton.Drive.Update.Files;
using Proton.Drive.Update.Files.Downloadable;
using Proton.Drive.Update.Files.Executable;
using Proton.Drive.Update.Files.UpdatesFolder;
using Proton.Drive.Update.Files.Validatable;
using Proton.Drive.Update.Releases;
using Proton.Drive.Update.Repositories;
...
/// </summary>
internal class AppUpdater : IAppUpdateCleanup
{
    ...
    internal void StartUpdating(Release release, bool forceNonSilent = false)
    {
        ...
        {
            commandBuilder.Append($" & if errorlevel 1 start \"\" \"{currentExecutablePath}\"");
