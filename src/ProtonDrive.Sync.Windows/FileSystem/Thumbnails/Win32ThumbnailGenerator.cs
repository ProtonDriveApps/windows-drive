...
using Gdi32 = ProtonDrive.Sync.Windows.Interop.Gdi32;
using Shell32 = ProtonDrive.Sync.Windows.Interop.Shell32;

namespace ProtonDrive.Sync.Windows.FileSystem.Thumbnails;
