...
internal partial struct HResult : IComparable, IComparable<HResult>, IEquatable<HResult>, IFormattable
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the full HRESULT value, as a <see cref="HResult.Code"/> enum.
    /// </summary>
    ...
    /// <summary>
    /// Converts a <see cref="HResult.Code"/> enum to its structural <see cref="HResult"/> representation.
    /// </summary>
    /// <param name="hr">The value to convert.</param>
    public static implicit operator HResult(Code hr) => new HResult(hr);

    /// <summary>
    /// Converts an <see cref="HResult"/> to its <see cref="HResult.Code"/> enum representation.
    /// </summary>
    /// <param name="hr">The value to convert.</param>
    ...
    /// <inheritdoc />
    public string ToString(string? format, IFormatProvider? formatProvider) => AsUInt32.ToString(format, formatProvider);
}
