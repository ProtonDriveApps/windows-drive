...
public static class ServiceConfigurator
{
    public static IServiceCollection AddSyncAgentServices(this IServiceCollection services)
    {
        return services
                ...
                .AddSingleton<ExcelTemporaryFileDetectionCounter>()
                .AddSingleton<IExcelTemporaryFileDetectionCounter>(provider => provider.GetRequiredService<ExcelTemporaryFileDetectionCounter>())
                .AddSingleton<IExcelTemporaryFileDetectionCountProvider>(provider => provider.GetRequiredService<ExcelTemporaryFileDetectionCounter>())
