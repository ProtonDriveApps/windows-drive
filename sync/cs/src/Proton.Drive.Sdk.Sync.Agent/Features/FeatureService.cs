...
using Proton.Drive.Sdk.Sync.Client.Features;
...
namespace Proton.Drive.Sdk.Sync.Agent.Features;

internal sealed class FeatureService : IFeatureFlagProvider, IStartableService, IAccountSwitchingAware, IAccountStateAware
{
