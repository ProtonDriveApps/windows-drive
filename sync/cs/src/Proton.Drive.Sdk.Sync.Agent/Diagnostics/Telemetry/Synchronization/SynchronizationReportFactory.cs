...
internal static class SynchronizationReportFactory
{
        ...
        OpenedDocumentsCounters openedDocumentsCounters)
    {
        ...
        values.Add(
            PeriodicReportMetricNames.NumberOfLocalStorageErrorFailures,
            syncStatistics.GetNumberOfFailuresByErrorCode(FileSystemErrorCode.LocalStorageError));
        ...
        var (numberOfSuccessfullySyncedExcelTemporaryFileCandidates, numberOfDetectedExcelTemporaryFileCandidates) = syncStatistics.GetExcelTemporaryFileCandidateCounters();

        values.Add(PeriodicReportMetricNames.NumberOfSuccessfullySyncedExcelTemporaryFileCandidates, numberOfSuccessfullySyncedExcelTemporaryFileCandidates);
        values.Add(PeriodicReportMetricNames.NumberOfDetectedExcelTemporaryFileCandidates, numberOfDetectedExcelTemporaryFileCandidates);
