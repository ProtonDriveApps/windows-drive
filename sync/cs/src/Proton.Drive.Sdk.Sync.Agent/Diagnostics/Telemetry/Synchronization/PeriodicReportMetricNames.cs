...
internal static class PeriodicReportMetricNames
{
    ...
    public const string NumberOfCloudFileProviderNotRunningFailures = "numberOfCloudFileProviderNotRunningFailures";
    public const string NumberOfCyclicRedundancyCheckFailures = "numberOfCyclicRedundancyCheckFailures";
    public const string NumberOfLocalStorageErrorFailures = "numberOfLocalStorageErrorFailures";
    ...
    public const string NumberOfSuccessfullySyncedExcelTemporaryFileCandidates = "numberOfSuccessfullySyncedExcelTemporaryFileCandidates";
    public const string NumberOfDetectedExcelTemporaryFileCandidates = "numberOfDetectedExcelTemporaryFileCandidates";
}
