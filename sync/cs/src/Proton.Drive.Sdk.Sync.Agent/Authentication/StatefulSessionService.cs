...
using IAuthenticationService = Proton.Drive.Sdk.Sync.Shared.Authentication.IAuthenticationService;
using MultiFactorAuthenticationMethods = Proton.Drive.Sdk.Sync.Shared.Authentication.MultiFactorAuthenticationMethods;

namespace Proton.Drive.Sdk.Sync.Agent.Authentication;
...
{
    private readonly Proton.Drive.Sdk.Sync.Client.Authentication.IAuthenticationService _clientAuthenticationService;
    ...
    public StatefulSessionService(
        Proton.Drive.Sdk.Sync.Client.Authentication.IAuthenticationService clientAuthenticationService,
