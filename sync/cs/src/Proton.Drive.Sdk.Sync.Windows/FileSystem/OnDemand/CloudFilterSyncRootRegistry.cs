...
public class CloudFilterSyncRootRegistry : IOnDemandSyncRootRegistry, ISessionStateAware
{
    ...
    private async Task<StorageProviderSyncRootInfo?> CreateSyncRootInfoAsync(OnDemandSyncRootInfo root)
    {
        ...
        try
        {
            ...
            var displayName = _appConfig.AppName + " - " + GetDisplayNameWithoutAccess(root.Path);
    ...
    private string? GetDisplayNameWithoutAccess(string path)
    {
