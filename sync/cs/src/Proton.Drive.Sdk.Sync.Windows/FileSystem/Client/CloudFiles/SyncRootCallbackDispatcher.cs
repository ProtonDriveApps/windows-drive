...
internal sealed class SyncRootCallbackDispatcher : IAsyncDisposable
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            using var hydrationProcess = new FileHydrationProcess<long>(fileInfo, checksumVerificationEnabled, dataTransferStream, _localVolumeInfoProvider, UpdateFileSize);
